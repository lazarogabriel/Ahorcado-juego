...
class UI{
    ...
    actualizaHorca(oportunidades){
        ...
        switch(oportunidades){
            case 5:
                imagen.src = 'resources/man_body/cabeza.png';
            break;
            case 4:
                imagen.src = 'resources/man_body/dorso.png';
            break;
            case 3:
                imagen.src = 'resources/man_body/brazo_derecha.png';
            break;
            case 2:
                imagen.src = 'resources/man_body/brazo_izquierda.png';
            break;
            case 1:
                imagen.src = 'resources/man_body/pierna_derecha.png';
            break;
            case 0:
                imagen.src = 'resources/man_body/pierna_izquierda_endgame.png';
            break;
